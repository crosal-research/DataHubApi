...
from DB.loaders.inflation.core_definitions import cores
from DB.loaders.inflation.core_definitions_2012 import cores2012
...
def add_cores(cpi:str, ini: Optional[str]=None, 
    ...
    for month in months:
        ...
        [add_obs(col, dt.fromisoformat(df.index[0]), df.loc[:, col].values[0]) for col in df.columns]
